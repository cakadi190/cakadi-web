                ...
                <header class="container">
                    <div class="d-flex gap-2 align-items-center">
                        ...
                        <xsl:if test="sitemap:sitemapindex">
                            <span class="badge bg-success text-white">Index</span>
                        </xsl:if>
                    ...
                    <h2 class="ma0 mt4 f4 normal">
                        <xsl:choose>
                            <xsl:when test="sitemap:sitemapindex">
                                This index contains
                                <strong class="badge bg-primary"><xsl:value-of select="count(sitemap:sitemapindex/sitemap:sitemap)"/></strong>
                                sitemaps.
                            </xsl:when>
                            <xsl:otherwise>
                                This index contains
                                <strong class="badge bg-primary"><xsl:value-of select="count(sitemap:urlset/sitemap:url)"/></strong>
                                URLs.
                            </xsl:otherwise>
                        </xsl:choose>
                    </h2>
