...
import { E as EmptyState, G as GlobalSection, a as GlobalSectionWithTitle } from "./Global-47c45cf2.js";
import { t as twMerge, g as getTextFromBg } from "./tailwind-b306cda1.js";
...
import { a as asset, B as Badge, s as storage, H as HomeLayout } from "./HomeLayout-15fea589.js";
...
function PortofolioContent({ data }) {
  ...
  return /* @__PURE__ */ jsxs("div", { className: "p-4 flex flex-col", children: [
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between gap-4 mb-3", children: [
      ...
      data.category && /* @__PURE__ */ jsx(
        Badge,
        {
          style: {
            background: data == null ? void 0 : data.category[0].background,
            color: getTextFromBg(data == null ? void 0 : data.category[0].background)
          },
          variant: "primary",
          className: "self-center flex-shrink-0",
          size: "sm",
          children: data.category && ((_a = data.category[0]) == null ? void 0 : _a.name)
        }
      )
    ] }),
    /* @__PURE__ */ jsx("p", { className: "text-gray-500 mb-0", children: data.highlight })
  ] });
}
