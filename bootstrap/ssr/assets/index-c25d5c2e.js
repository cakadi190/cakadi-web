...
import { D as Dropdown } from "./Dropdown-a2db643d.js";
...
import { B as Badge, s as storage, H as HomeLayout } from "./HomeLayout-15fea589.js";
import { G as GlobalSection, E as EmptyState } from "./Global-47c45cf2.js";
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row justify-between gap-4 mb-3", children: [
      ...
      category && /* @__PURE__ */ jsx(
        Badge,
        {
          variant: "primary",
          style: {
            background: category[0].background,
            color: getTextFromBg(category[0].background)
          },
...
function HeaderPartial() {
  return /* @__PURE__ */ jsx("header", { className: "grid grid-cols-12", children: /* @__PURE__ */ jsxs("div", { className: "col-span-12 md:col-span-5", children: [
    ...
    /* @__PURE__ */ jsxs("nav", { className: "flex items-center flex-wrap text-sm font-semibold py-3", children: [
      ...
      /* @__PURE__ */ jsx("span", { className: "text-gray-500", children: "Portofolio" })
    ] })
  ] }) });
}
